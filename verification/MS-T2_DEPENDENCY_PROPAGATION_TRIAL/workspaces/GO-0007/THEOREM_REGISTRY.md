# Morning Star — Volume I Theorem Registry
...
## 3. Theorem MS-T1 — Governed Initiation Necessity
...
## 4. Theorem MS-T2 — Dependency Propagation
...
## 5. Theorem MS-T3 — Capability Non-Creation of Authority
...
## 6. Theorem MS-T4 — Domain and Version Relativity
...
## 7. Theorem MS-T5 — Material Change Revalidation
...
## 8. Theorem MS-T6 — Uncertainty Non-Erasure
...
## 9. Theorem MS-T7 — Scope Non-Expansion
...
## 10. Theorem MS-T8 — Non-Aggregation of Competence
...
## 11. Theorem MS-T9 — Performance Non-Canonicality
...
The theorem is falsified if computational performance alone can reliably establish canonical authority without assignment, governance, or traceability.
...
Superseded theorems shall retain traceability.
